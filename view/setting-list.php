...
<div class="my_head width_1000">
    <div class="my_head_img" id="my_head_img">
    ...
    <div class="my_head_message">
        <ul class="fl">
            <li>注册于：<?php echo date($user['addtime']) ?></li>
        </ul>
    ...
    <div class="left setting-head">
        ...
        <div class="ui bottom attached tab segment segment_new" data-tab="second">
            <form class="ui form" method="post" action="saveSetting.php">
                ...
                <div class="field">
                    <label>注册日期</label>
                    <input type="text"  value="<?php echo date($user['addtime']) ?> " readonly>
                </div>
                <div class="field">
                    <label>性别</label>
        ...
        <div class="ui bottom attached tab segment segment_new" data-tab="third">
            <div class="ui form">
                ...
                <div id="save-pwd" class="ui submit teal  button ">确认</div>
            </div>
        </div>
    </div>
